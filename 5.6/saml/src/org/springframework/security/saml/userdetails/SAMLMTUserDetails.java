...
public class SAMLMTUserDetails extends SAMLUserDetails implements MTUserDetails {

    private List<TenantInfo> tenantList;
    
    public SAMLMTUserDetails(GrantedAuthority[] authorities, String username, List<TenantInfo> tenantList) {
