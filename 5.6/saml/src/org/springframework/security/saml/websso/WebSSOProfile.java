...
public class WebSSOProfile {
     ...
     */
    public WebSSOProfile(MetadataManager metadata, KeyStoreCredentialResolver keyManager, String signingKey) throws SAMLException {
     ...
     */
    public void initializeSSO(HttpServletRequest request, HttpServletResponse response) throws SAMLException, MetadataProviderException, MessageEncodingException {
     ...
     * @throws MessageEncodingException  error forming SAML message
     */
    public void initializeSSO(String idp, HttpServletRequest request, HttpServletResponse response) throws SAMLException, MetadataProviderException, MessageEncodingException {
     ...
     * @throws MessageEncodingException  error forming SAML message
     */
    public void initializeSSO(String binding, String idpId, HttpServletRequest request, HttpServletResponse response) throws SAMLException, MetadataProviderException, MessageEncodingException {
    ...
    public BasicSAMLMessageContext processSSO(HttpServletRequest request) throws SAMLException, MetadataProviderException, MessageDecodingException, org.opensaml.xml.security.SecurityException {
        ...
        log.debug("Setting peerentityid using default from metadata: " + metadata.getDefaultIDP());
        log.debug("Setting peer entity metadata: " +metadata.getEntityDescriptor(metadata.getDefaultIDP()));
        samlContext.setPeerEntityMetadata(metadata.getEntityDescriptor(metadata.getDefaultIDP()));
        log.debug("Setting peerentityid using id from metadata: " + samlContext.getPeerEntityMetadata().getEntityID() );
      ...
      //  SAMLUtil.debugprintSAMLObject(message);
       // }
log.debug("Successfully setup peer entity metadata.");
        return samlContext;
     ...
     */
    protected AuthnRequest getAuthnRequest(EntityDescriptor idpEntityDescriptor, AssertionConsumerService assertionConsumber, SingleSignOnService bindingService) throws SAMLException, MetadataProviderException {
